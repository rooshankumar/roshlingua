...
export const ChatScreen = ({ conversation }: Props) => {
  ...
  return (
    <Card className="fixed inset-0 flex flex-col w-full h-full md:static md:h-screen md:max-w-none md:rounded-none border-none shadow-none overflow-hidden bg-gradient-to-b from-background/95 to-background/90 backdrop-blur-lg">
